...
class _ChatAudioScreenState extends State<ChatAudioScreen> {
  // BaseWidget<DoctorInformationSignUpModel>.staticBuilder
  ...
  Widget singleCall(
      {String name, String image, bool micOn = false, bool cameraOn = false}) {
    return Container(
        ...
        children: [
          InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  color:
                      themeData.colorScheme.primary.withAlpha(isAudioOn ? 40 : 0),
          ...
          InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  color:
                      themeData.colorScheme.primary.withAlpha(isVideoOn ? 40 : 0),
                  shape: BoxShape.circle),
              child: Icon(
